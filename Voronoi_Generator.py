...
def surfaceMaterial(obj, H, S, V):
    name = (obj + '_shaderMaterial')
...
def voroShatter(object, num):
    ...
    # Place the random points for polycut, based onr the bounding box
    numPoints = num
...
for sel in selected:
    surfaceMat = surfaceMaterial(sel, 240, 0.5, 1)
    voroShatter(sel, 50)