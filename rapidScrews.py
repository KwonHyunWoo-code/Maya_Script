...
meshDirectory = 'D:\Python\Maya\samples'
...
def jwMeshPlaceUI():
    ...
    mc.intSliderGrp( 'iconSize', cw3=[100, 40, 250], label = '   Icon Size         ',  field= 1, min= 1, max= 5, v = 5 ,cc= 'jwfloatResizeIcon()', dc= 'jwfloatResizeIcon()')
    mc.setParent( '..' )
